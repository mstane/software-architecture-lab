...
public class ReaderRestControllerTest extends BaseRestControllerTest {
  ...
  public void search() throws Exception {
    loadReaders(7);
    mockMvc.perform(get(RESOURCE_PATH + "?search=rac3&pageNumber=0&pageSize=5")).andDo(print())
  ...
  public void update() throws Exception {
    ...
    mockMvc
        .perform(put(RESOURCE_PATH + reader.getId()).with(csrf().asHeader()).contentType(contentType).content(readerJson))
