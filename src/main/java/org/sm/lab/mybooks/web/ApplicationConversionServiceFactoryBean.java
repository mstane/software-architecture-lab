...
public class ApplicationConversionServiceFactoryBean extends FormattingConversionServiceFactoryBean {
	...
	public Converter<Book, String> getBookToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.sm.lab.mybooks.domain.Book, java.lang.String>() {
	...
	public Converter<Long, Book> getIdToBookConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.sm.lab.mybooks.domain.Book>() {
            public org.sm.lab.mybooks.domain.Book convert(java.lang.Long id) {
	...
	public Converter<String, Book> getStringToBookConverter() {
		return new org.springframework.core.convert.converter.Converter<java.lang.String, org.sm.lab.mybooks.domain.Book>() {
			public org.sm.lab.mybooks.domain.Book convert(String id) {
	...
	public Converter<Note, String> getNoteToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.sm.lab.mybooks.domain.Note, java.lang.String>() {
	...
	public Converter<Long, Note> getIdToNoteConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.sm.lab.mybooks.domain.Note>() {
            public org.sm.lab.mybooks.domain.Note convert(java.lang.Long id) {
	...
	public Converter<String, Note> getStringToNoteConverter() {
		return new org.springframework.core.convert.converter.Converter<java.lang.String, org.sm.lab.mybooks.domain.Note>() {
			public org.sm.lab.mybooks.domain.Note convert(String id) {
	...
	public Converter<Reader, String> getReaderToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.sm.lab.mybooks.domain.Reader, java.lang.String>() {
	...
	public Converter<Long, Reader> getIdToReaderConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.sm.lab.mybooks.domain.Reader>() {
            public org.sm.lab.mybooks.domain.Reader convert(java.lang.Long id) {
	...
	public Converter<String, Reader> getStringToReaderConverter() {
		return new org.springframework.core.convert.converter.Converter<java.lang.String, org.sm.lab.mybooks.domain.Reader>() {
			public org.sm.lab.mybooks.domain.Reader convert(String id) {
