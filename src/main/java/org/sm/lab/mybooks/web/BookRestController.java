...
public class BookRestController {
    ...
    public Page<Book> list(@RequestParam(value = "pageNumber", required = false) Integer pageNumber,
    ...
    public Page<SearchItem> searchContent(@RequestParam("search") String keyword,
